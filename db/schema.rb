...
ActiveRecord::Schema.define(version: 20150522055511) do
  ...
  add_index "flights", ["from_airport_id", "to_airport_id"], name: "index_flights_on_from_airport_id_and_to_airport_id"
